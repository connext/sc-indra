...
import { CreateChannelValidatorImpl } from '../data/deposit/deposit.validator.impl';
...
container.register({
  ...
  depositValidator: asClass(CreateChannelValidatorImpl),
  transferValidator: asClass(TransferValidatorImpl),

  // interactors
  signupInteractor: asClass(SignupInteractor),
  depositInteractor: asClass(CreateChannelInteractor),
